...
class ServiceWorker @Inject constructor(
    @ApplicationContext
    appContext: Context,
) {
    ...
    private val periodicWorkerRequest = PeriodicWorkRequestBuilder<Worker>(
        PeriodicWorkRequest.MIN_PERIODIC_INTERVAL_MILLIS,
        TimeUnit.MINUTES
    ).setConstraints(workConstraints).build()

    private val onTimeWorkRequest =
    ...
    fun stop() {
        workManager.cancelUniqueWork(SERVICE)
    }
